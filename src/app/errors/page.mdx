...
<Note>
  ...
  your code before contacting Castr GÜRŲ support.
</Note>
...
Here is a list of the different categories of status codes returned by the Castr GÜRŲ API. Use these to understand if a request was successful.
